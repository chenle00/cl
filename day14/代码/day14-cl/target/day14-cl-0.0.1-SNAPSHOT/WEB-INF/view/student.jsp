        ...
        <div class="row">
			<div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">学生 姓名 </span>
				...
				<div class="modal-body">
					<form id="form_teacher" method="post" action="reserveTeacher.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入校时间：</td>
								<td><input placeholder="入校时间" type="date" id="entrytime" name="entrytime" class="laydate-icon form-control layer-date"/></td>
								<td>&nbsp;&nbsp;</td>
							</tr>
						</table>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						<form id="personId" action="importStudent.htm" method="post" enctype="multipart/form-data">
