...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="contentcategoryid" id = "txt_search_depid">
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_user_emp" role="dialog" aria-labelledby="modal_user_emp" aria-hidden="true">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
							...
							<tr>
								...
								<tr>
									...
									<td><input type="text" id="createtime" name="createtime"
										class="laydate-icon form-control layer-date" readonly="readonly" aria-required="true" required/></td>
									<td>&nbsp;&nbsp;</td>
									<td>广告链接：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_emp_btn">保存</button>
	...
	$(function () {
	    ...
	    $("#submit_form_emp_btn").click(function(){
	    	$("#form_user").submit();
	    });
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            contentcategoryid: $("#txt_search_depid").val(),
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_edit").click(function(){
	    		...
	    		if(getSelections && getSelections.length==1){
	    			...
	    			$('#modal_user_emp').modal({backdrop: 'static', keyboard: false});
					$('#modal_user_emp').modal('show');
	    		}else{
